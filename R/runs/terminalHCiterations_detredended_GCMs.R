...
for(i in 1:length(namescubics)){
  dir.create(paste0("data/hciterations_detrended/",namescubics[i]))
}


for(i in 1:length(namescubics)){
 dir.create(paste0("data/hciterations_detrended/",namescubics[i],"/perm",k))
  dir.create(paste0("data/hciterations_detrended/",namescubics[i],"/perm",k,"train"))
  dir.create(paste0("data/hciterations_detrended/",namescubics[i],"/perm",k,"test"))
}
...
#   set <- s
#   
#   dataset <- detrendGrid(cubicsets[[set]])
...
for(s in 1:length(cubicsets)){
  ...
  for (m in 0:(last/steps)) {
    ...
    save(list = paste0(shortnames[set],"_",k,"_",i,"_",j,"i"), 
         file = paste0("data/hciterations_detrended/",namescubics[set],"/perm",k,"/",shortnames[set],"_",k,"_",i,"_",j,"i_detrended.rda"))
...
#####################################################################################
# dir.create(paste0("data/hciterations_detrended/JRA55_10d_akima_cubic"))
# dir.create(paste0("data/hciterations_detrended/JRA55_10d_akima_cubic/perm3"))
# dir.create(paste0("data/hciterations_detrended/JRA55_10d_akima_cubic/perm3train"))
# dir.create(paste0("data/hciterations_detrended/JRA55_10d_akima_cubic/perm3test"))

####################################################################################
# permutations k, until 2000 JRA55 data
####################################################################################
k <- 3
for(s in namescubics){
  ...
  for (m in 0:(last/steps)) {
    ...
    save(list = paste0(set,"_",k,"_",i,"_",j,"i"), 
         file = paste0("data/hciterations_detrended/",set,"/perm",k,"/",set,"_",k,"_",i,"_",j,"i_detrended.rda"))
...
# k <- 3
# for(i in 1:length(namescubics)){
#   dir.create(paste0("data/hciterations_detrended/FUTURE_",namescubics[i]))
# }
# 
# for(i in 1:length(namescubics)){
#  dir.create(paste0("data/hciterations_detrended/FUTURE_",namescubics[i],"/perm",k))
#   dir.create(paste0("data/hciterations_detrended/FUTURE_",namescubics[i],"/perm",k,"train"))
#   dir.create(paste0("data/hciterations_detrended/FUTURE_",namescubics[i],"/perm",k,"test"))
# }
...
for(s in 1:length(cubicsets)){
  ...
  for (m in 0:(last/steps)) {
    ...
    save(list = paste0(shortnames[set],"_",k,"_",i,"_",j,"i"), 
         file = paste0("data/hciterations_detrended/FUTURE_",namescubics[set],"/perm",k,"/",shortnames[set],"_",k,"_",i,"_",j,"i_detrended.rda"))
